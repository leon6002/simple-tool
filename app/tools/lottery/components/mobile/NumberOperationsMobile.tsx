...
const NumberOperationsMobile = ({
  ...
  return (
    <>
      <div className="md:hidden mt-2 flex flex-col gap-2 w-full">
        {/* 主操作按钮组 - 2列布局 */}
        <div className="grid grid-cols-2 gap-2">
          <Sheet>
            <SheetTrigger asChild>
              <Button
                className="w-full bg-linear-to-r from-blue-500 to-blue-600 text-white hover:opacity-90 transition-all shadow-md h-10"
                size="sm"
              >
                  ...
                  <CardContent>
                    <div>
                      <div className="grid grid-cols-2 gap-3">
                        <Button
                          variant={
                            algorithm === "random" ? "default" : "outline"
                          }
          ...
          <Button
            size="sm"
            className="w-full bg-linear-to-r from-amber-500 to-pink-500 text-white hover:opacity-90 transition-all shadow-md h-10"
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <Button
            onClick={saveNumbers}
            className="w-full bg-linear-to-r from-blue-500 to-emerald-600 text-white hover:opacity-90 transition-all text-sm h-10"
            size="sm"
          >
