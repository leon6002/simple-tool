    ...
    <div className="container mx-auto max-w-6xl py-12 md:py-16 lg:py-20 px-4 md:px-8">
      ...
      >
        <div className="mb-12 text-center">
          ...
          >
            <ScanText className="h-8 w-8 text-purple-600" />
          </motion.div>
        ...
        <Card className="border-border/50 shadow-xl shadow-purple-500/5">
          ...
          <CardContent className="space-y-4">
            <p className="font-medium">The OCR Tool will support:</p>
            <ul className="space-y-3 text-muted-foreground">
              <li className="flex items-start gap-3 p-3 rounded-lg hover:bg-muted/50 transition-colors">
                <Camera className="h-5 w-5 text-purple-600 shrink-0 mt-0.5" />
                <span>Extract text from images (JPG, PNG, PDF)</span>
              </li>
              <li className="flex items-start gap-3 p-3 rounded-lg hover:bg-muted/50 transition-colors">
              ...
              <li className="flex items-start gap-3 p-3 rounded-lg hover:bg-muted/50 transition-colors">
                <Copy className="h-5 w-5 text-purple-600 shrink-0 mt-0.5" />
                <span>Copy extracted text to clipboard</span>
              </li>
              <li className="flex items-start gap-3 p-3 rounded-lg hover:bg-muted/50 transition-colors">
              ...
              <li className="flex items-start gap-3 p-3 rounded-lg hover:bg-muted/50 transition-colors">
                <ScanText className="h-5 w-5 text-purple-600 shrink-0 mt-0.5" />
